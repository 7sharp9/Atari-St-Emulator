...
"""
# ============================================================================
# Routine index (hand-maintained, generated by eyeball - re-check by grepping
# `^def ` and `\$[0-9a-f]{4,5}` above and cross-diffing against
# reversing/powermonger/ai.md's own status prose; NOT an automated build
# step, so it can drift - trust the file/ai.md over this table if they
# disagree, then fix whichever is stale).
#
#   $addr    function                line   pass         status
#   -----    --------                ----   ----         ------
#   $1648e   terrain_sample          146    94th         Proven
#   $16778   bucket_unlink           173    93rd-99th    Proven (used by every proven mode handler)
#   $163ea   relink                  205    94th         Proven
#   $5c80    upkeep                  241    93rd         Proven
#   $161c4   epilogue_161c4          265    93rd/94th    Proven
#   $14262   heading                 326    94th         Proven
#   $12d56   rotate                  351    94th         Proven
#   $164bc   step_toward             381    94th         Proven
#   $16202   epilogue_16202          435    94th         Proven
#   $14d32   h_mode06                443    94th         Proven
#   $14d7c   h_mode08                471    94th         Proven
#   $14cfa   h_mode02                508    94th         Proven
#   $14e70   h_mode0e                524    94th         Proven
#   $14f08   h_mode10                564    94th         Proven
#   $30fe    call_30fe               650    95th         Proven
#   $5778    bookkeep_5778           658    95th/115th   Corroborated (only its $4bc8 sub-call is Proven, 115th)
#   $56a6    engage_56a6             683    95th         Proven ($574a path)
#   $5590    kill_rout_5590          719    95th         Proven (KILL branches only; ROUT->$3c08 arm asserted off)
#   $1533c   h_mode32                778    95th         Proven
#   $16848   call_16848              821    96th         Proven
#   $163b8   call_163b8              838    96th/97th    Proven
#   $158ae   _revolt_check           849    96th         Corroborated (ASSERTED OFF - $550e revolt arm out of scope)
#   $157e6   h_mode7c                856    96th/97th    Proven
#   $16892   call_16892              922    98th         Proven
#   $17a46   call_17a46              972    99th         Proven (tracked no-op)
#   $1d70    call_1d70               978    99th         Proven
#   $1b8c    call_1b8c              1060    99th         Proven (group-teardown call site); a *different*
#                                                         $5778-reached $1b8c call site remains Corroborated
#   $37c2    call_37c2              1096    99th         Proven
#   $3c08    call_3c08              1130    98th/99th    Proven (dispatcher 98th, teardown subtree 99th)
#   $157ba   h_mode7c_regroup       1159    98th         Proven
#   $16808   call_16808             1168    93rd-116th   Proven (used by every proven mode handler)
#   $4342    call_4342              1193    113th        Proven, 8/9 branches
#   $4de2    _classify              1384    115th/116th  Proven
#   $4dae    call_4dae              1439    115th/116th  Proven
...
# _cos/_spw/_objaddr/_clamp/_prog_b/_dwell_dance_8/_melee_lost/_cell_of/
# _unpack_cell_y/init_tables/reconstruct/in_tracked_region/
...
def call_3c08(m, A1):
    ...
    m.wb(A1 + 20, cell & 0x3f)                       # andi.w #$3f,D0 ; move.b D0,20(A1)
    m.wb(A1 + 21, 0x80)                              # move.b #$80,21(A1)
    m.ww(A1 + 22, _unpack_cell_y(cell))              # andi.w #$1fc0,D0 ; lsl.w #2,D0 ; move.b #$80,D0
    m.wb(A1 + 31, 0x10)                              # move.b #$10,31(A1)
                ...
                if a2 is not None:
                    ...
                    while True:
                        ...
                        if m.bs(a3 + 5) > 0:
                            ...
                            m.wb(a3 + 8, cell & 0x3f)
                            m.wb(a3 + 9, 0x80)
                            m.ww(a3 + 10, _unpack_cell_y(cell))
...
def _unpack_cell_y(cell):
    """packed map cell -> the y-word half of a target position, the
    andi#$1fc0/lsl#2/addi#$80 formula used throughout the $14b62 tree
    (the inverse-direction counterpart of _cell_of's y-packing)."""
    return (((cell & 0x1fc0) << 2) + 0x80) & 0xffff
