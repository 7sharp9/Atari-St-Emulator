...
- **Contact resolves everything.** Walkers meeting on a cell merge (friends) or fight (enemies):
  ...
  mana from the loser; a winning knight razes a town, any other winner takes it over: the town's
  land is released and the winner founds its own settlement on the cell where it stands, if that
  land can hold one. (M 3.3, M 3.5, M 4.3)
